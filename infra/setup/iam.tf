########################################################################
# Create IAM roles and policies for Continuous Deployment (CD) account #
########################################################################
...
resource "aws_iam_policy" "tf_backend" {
  ...
  description = "Allow user to use policy for TF backend resources to access S3 and Dynamo DB"
